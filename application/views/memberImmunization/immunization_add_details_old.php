            ...
            <div class="row">
                        ...
                        <select class="form-control" id="fk_followup_exit_type" name="fk_followup_exit_type" required>
                            ...
                            if (!empty($child_follow_up_exit_type)) {
                                foreach ($child_follow_up_exit_type as $child_follow_up_exit_type_single) {
                                    ?>
                                    <option value="<?php echo $child_follow_up_exit_type_single->id ?>"><?php echo $child_follow_up_exit_type_single->code . '-' . $child_follow_up_exit_type_single->name ?></option>
                                    <?php
                                }
                            }
                            ?>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="folowup_exit_round" required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input autocomplete="off" type="text" class="form-control date_format"  name="FIPV1" >
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="FIPV1OTH"  name="FIPV1OTH">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="FIPV2">Fipv2</label>
                        <input autocomplete="off" type="text" class="form-control date_format"  name="FIPV2" >
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="FIPV2OTH"  name="FIPV2OTH">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="FIPV3">Fipv3</label>
                        <input autocomplete="off" type="text" class="form-control date_format"  name="FIPV3" >
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="FIPV3OTH"  name="FIPV3OTH">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="CODER" required>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
