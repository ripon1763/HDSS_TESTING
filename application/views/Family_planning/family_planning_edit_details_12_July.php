...
<form action="<?php echo base_url() . 'Family_planning/editFPDetails?baseID=' . $baseID ?>" id="myForm" role="form" data-toggle="validator" method="post" accept-charset="utf-8">
    ...
    <div id="asset" style="padding-left: 20px; padding-right: 20px">
        ...
        <div id="form-step-0" role="form" data-toggle="validator">
            ...
            <div class="martial_status_dependent_part">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4 current_pregnancy_status_non_yes_part">
                        <div class="form-group">
                            <label for="husband_living_place">আপনার স্বামী সচরাচর কোথায় বসবাস করেন?</label>
                    ...
                    <div class="col-md-12 current_pregnancy_status_non_yes_part">
                        <div class="form-group">
                            <label for="birth_control_method_usage_status">আপনি বা আপনার স্বামী কি গর্ভধারণ বিলম্বিত বা গর্ভধারণ না করার জন্য বর্তমানে জন্ম নিয়ন্ত্রণের কোনো পদ্ধতি ব্যবহার করেন?  
                            </label>
                    ...
                    <div class="col-md-12 current_pregnancy_status_non_yes_part birth_control_method_usage_status_yes_part">
                        <div class="form-group">
                            <label for="birth_control_method">কোন পদ্ধতি ব্যবহার করেন?   </label>
                    ...
                    <div class="col-md-12 birth_control_method_other_part current_pregnancy_status_non_yes_part birth_control_method_usage_status_yes_part">
                        <div class="form-group">
                    ...
                    <div class="col-md-6 current_pregnancy_status_non_yes_part birth_control_method_usage_status_yes_part">
                        <div class="form-group">
                            <label for="how_long">একনাগারে কতদিন যাবৎ আপনারা বর্তমান পদ্ধতি ব্যবহার করছেন?</label>
                            <div class="row">
                                <div class="col-md-3">
                    ...
                    <div class="col-md-12 current_pregnancy_status_non_yes_part birth_control_method_usage_status_yes_part">
                        <div class="form-group">
                            <label for="birth_control_method_suggestion_from_where">সর্বশেষবার কোথা থেকে আপনারা বর্তমান ব্যবহৃত পদ্ধতি সংগ্রহ করেছিলেন বা পরামর্শ পেয়েছিলেন? 
                            </label>
                    ...
                    <div class="col-md-12 birth_control_method_suggestion_from_where_other_part current_pregnancy_status_non_yes_part birth_control_method_usage_status_yes_part">
                        <div class="form-group">
                    ...
                    <div class="col-md-12 current_pregnancy_status_non_yes_part birth_control_method_usage_status_yes_part">
                        <div class="form-group">
                            <label for="whose_decision">আপনারা যে জন্ম নিয়ন্ত্রন পদ্ধতি ব্যবহার করেন এই সিদ্ধান্ত: আপনার নাকি আপনার স্বামীর নাকি স্বামী স্ত্রীর দুজনের? </label>
                    ...
                    <div class="col-md-12 whose_decision_other_part current_pregnancy_status_non_yes_part birth_control_method_usage_status_yes_part">
                        <div class="form-group">
                    ...
                    <div class="col-md-12 current_pregnancy_status_non_yes_part birth_control_method_usage_status_yes_part whose_decision_part">
                        <div class="form-group">
                            <label for="reason_behind_not_using">আপনারা যে,বর্তমানে জন্ম নিয়ন্ত্রন পদ্ধতি ব্যবহার করছেন না তার প্রধান কারন কি?</label>
                    ...
                    <div class="col-md-6 reason_behind_not_using_other_part current_pregnancy_status_non_yes_part birth_control_method_usage_status_yes_part whose_decision_part">
                        <div class="form-group">
                    ...
                    <div class="col-md-6 whose_decision_part">
                        <div class="form-group">
                            <label for="future_desire">ভবিষ্যতে আপনাদের জন্মনিয়ন্ত্রন পদ্ধতি ব্যবহার করার ইচ্ছা আছে কি?</label>
                    ...
                    <div class="col-md-6 whose_decision_part">
                        <div class="form-group">
                            <label for="reason_behind_not_having_future_desire">ভবিষ্যতে আপনারা যে জন্মনিয়ন্ত্রন পদ্ধতি ব্যবহার করতে চান না তার প্রধান কারন কি?</label>
                    ...
                    <div class="col-md-6 reason_behind_not_having_future_desire_other_part">
                        <div class="form-group">
                    ...
                    <div class="col-md-6 whose_decision_part">
                        <div class="form-group">
                            <label for="do_you_know_from_where">পরিবার পরিকল্পনা পদ্ধতি কোথা থেকে পেতে পারেন,তা কি আপনি জানেন? </label>
                ...
                <div class="row whose_decision_part">
                    <fieldset class="scheduler-border">
                        <legend class="scheduler-border">কোথা থেকে নিতে পারেন? (একাধিক উত্তর হতে পারে)</legend>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="email"></label>
                                <div class="checkbox">
                                    <label><input value="<?php if ($familyPlanningRecord->available_govt_hospital > 0) echo $familyPlanningRecord->available_govt_hospital; ?>" name="available_govt_hospital" type="checkbox" value="1">সরকারি হাসপাতাল / মেডিকেল কলেজ হাসপাতাল</label>
                                </div>
                                <div class="checkbox">
                                    <label><input value="<?php if ($familyPlanningRecord->available_central_dist_hospital > 0) echo $familyPlanningRecord->available_central_dist_hospital; ?>" name="available_central_dist_hospital" type="checkbox" value="2">জেলা সদর হাসপাতাল</label>
                                </div>
                                <div class="checkbox">
                                    <label><input value="<?php if ($familyPlanningRecord->available_matri_sonod > 0) echo $familyPlanningRecord->available_matri_sonod; ?>" name="available_matri_sonod" type="checkbox" value="3">মাতৃসদন/মাতৃমঙ্গল/মেটারনিটি</label>
                                </div>
                                <div class="checkbox">
                                    <label><input value="<?php if ($familyPlanningRecord->available_ngo_facility > 0) echo $familyPlanningRecord->available_ngo_facility; ?>" name="available_ngo_facility" type="checkbox" value="4">NGO facility supported by UPHCSDP</label>
                                </div>
                                <div class="checkbox">
                                    <label><input value="<?php if ($familyPlanningRecord->available_upazilla_sasthokendro > 0) echo $familyPlanningRecord->available_upazilla_sasthokendro; ?>" name="available_upazilla_sasthokendro" type="checkbox" value="5">উপজেলা স্ব্যাস্থকেন্দ্র</label>
                                </div>
                                <div class="checkbox">
                                    <label><input value="<?php if ($familyPlanningRecord->available_union_sastho_poribar_kollan_kendro > 0) echo $familyPlanningRecord->available_union_sastho_poribar_kollan_kendro; ?>" name="available_union_sastho_poribar_kollan_kendro" type="checkbox" value="6">ইউনিয়ন স্ব্যাস্থ ও পরিবারকল্যান কেন্দ্র</label>
                                </div>
                                <div class="checkbox">
                                    <label><input value="<?php if ($familyPlanningRecord->available_satellite_clinic > 0) echo $familyPlanningRecord->available_satellite_clinic; ?>" name="available_satellite_clinic" type="checkbox" value="7">স্যাটেলাইটক্লিনিক/ইপিআই প্রোগ্রাম</label>
                                </div>
                                <div class="checkbox">
                                    <label><input value="<?php if ($familyPlanningRecord->available_community_clinic > 0) echo $familyPlanningRecord->available_community_clinic; ?>" name="available_community_clinic" type="checkbox" value="8">কমিউনিটি ক্লিনিক</label>
                                </div>
                                <div class="checkbox">
                                    <label><input value="<?php if ($familyPlanningRecord->available_ngo_and_satellite_clinic > 0) echo $familyPlanningRecord->available_ngo_and_satellite_clinic; ?>" name="available_ngo_and_satellite_clinic" type="checkbox" value="9">এনজিও স্যাটেলাইট ক্লিনিক</label>
                                </div>
                                <div class="checkbox">
                                    <label><input value="<?php if ($familyPlanningRecord->available_ngo_and_static_clinic > 0) echo $familyPlanningRecord->available_ngo_and_static_clinic; ?>" name="available_ngo_and_static_clinic" type="checkbox" value="10">এনজিও স্ট্যাটিক ক্লিনিক</label>
                                </div>
                                <div class="checkbox">
                                    <label><input value="<?php if ($familyPlanningRecord->available_private_hospital > 0) echo $familyPlanningRecord->available_private_hospital; ?>" name="available_private_hospital" type="checkbox" value="11">প্রাইভেট হাসপাতাল/ক্লিনিক</label>
                                </div>
                                <div class="checkbox">
                                    <label><input value="<?php if ($familyPlanningRecord->available_mbbs_doctor_chamber > 0) echo $familyPlanningRecord->available_mbbs_doctor_chamber; ?>" name="available_mbbs_doctor_chamber" type="checkbox" value="12">এমবিবিএস ডাক্তার চেম্বার</label>
                                </div>
                                <div class="checkbox">
                                    <label><input value="<?php if ($familyPlanningRecord->available_doctor_without_degrees > 0) echo $familyPlanningRecord->available_doctor_without_degrees; ?>" name="available_doctor_without_degrees" type="checkbox" value="13">ডিগ্রীধারি ডাক্তারের চেম্বারেনা</label>
                                </div>
                                <div class="checkbox">
                                    <label><input value="<?php if ($familyPlanningRecord->available_pharmacy > 0) echo $familyPlanningRecord->available_pharmacy; ?>" name="available_pharmacy" type="checkbox" value="14">ফার্মেসী</label>
                                </div>
                                <div class="checkbox">
                                    <label><input value="<?php if ($familyPlanningRecord->available_other > 0) echo $familyPlanningRecord->available_other; ?>" name="available_other" id="available_other" type="checkbox" value="15">অন্যান্য (উল্লেখ করুন)</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 available_other_part">
                            <div class="form-group">
                                <label for="available_other_value">এখানে উল্লেখ করুন</label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="taking_desire_more_children">আপনার (আরও) ছেলেমেয়ে নেয়ার ইচ্ছা আছে কি?</label>
                    ...
                    <div class="col-md-6 taking_desire_more_children_after_year_part">
                        <div class="form-group">
                            <label for="taking_desire_more_children_after_year">যদি হ্যাঁ হয় কত বছর পর? (যদি বাচ্চা না চায় তাহলে বক্সে “0” লিখুন)</label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="how_many_children_you_want">আপনি যতজন সন্তান চান আপনার স্বামী কি ততজনই সন্তান চান না কি তার চেয়ে বেশি চান নাকি তার চেয়ে কম চান?</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="alive_children">আপনার কতজন জীবিত ছেলেমেয়ে আছে?</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="alive_boy_number">ছেলে সংখ্যা</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="alive_girl_number">মেয়ে সংখ্যা</label>
                    ...
                    <div class="col-md-12 alive_children_yes_availability_part">
                        <div class="form-group">
                            <label for="alive_children_yes_availability">জীবিত ছেলে-মেয়ে আছে? আপনি যদি আপনার পূর্বের জীবনে ফিরে যেতে পারতেন,যখন আপনার কোন ছেলে-মেয়ে ছিল না এবং আপনি যদি সঠিক সংখ্যা নির্ধারণ করতে পারতেন তাহলে সারা জীবনে কতজন ছেলে-মেয়ে নিতেন?</label>
                    ...
                    <div class="col-md-12 alive_children_yes_availability_other_part">
                        <div class="form-group">
                    ...
                    <div class="col-md-12 alive_children_yes_availability_how_many_part">
                        <div class="form-group">
                    ...
                    <div class="col-md-12 alive_children_no_availability_related_part alive_children_yes_availability_parts">
                        <div class="form-group">
                            <label for="alive_children_no_availability">জীবিত ছেলে-মেয়ে নাই? আপনি যদি সঠিক সংখ্যা নির্ধারণ করতে পারতেন তাহলে সারাজীবনে কতজন ছেলে-মেয়ে নিতেন?</label>
                    ...
                    <div class="col-md-12 alive_children_no_availability_related_part alive_children_no_availability_parts alive_children_yes_availability_parts alive_children_no_availability_other_part">
                        <div class="form-group">
                    ...
                    <div class="col-md-12 alive_children_no_availability_related_part alive_children_no_availability_parts alive_children_yes_availability_parts alive_children_no_availability_how_many_part">
                        <div class="form-group">
                    ...
                    <div class="col-md-12 alive_children_no_availability_non_related_part alive_children_no_availability_parts alive_children_yes_availability_parts">
                        <div class="form-group">
                            <label for="how_many_male_female_children">এদের মধ্যে কতজন ছেলে কতজন মেয়ে নিতেন,নাকি ছেলে-মেয়ে কোন ব্যাপার না</label>
                    ...
                    <div class="col-md-4 alive_children_no_availability_non_related_part alive_children_no_availability_parts alive_children_yes_availability_parts">
                        <div class="form-group">
                            <label for="how_many_male">ছেলে সংখ্যা</label>
                    ...
                    <div class="col-md-4 alive_children_no_availability_non_related_part alive_children_no_availability_parts alive_children_yes_availability_parts">
                        <div class="form-group">
                            <label for="how_many_female">মেয়ে সংখ্যা</label>
                    ...
                    <div class="col-md-4 alive_children_no_availability_non_related_part alive_children_no_availability_parts alive_children_yes_availability_parts">
                        <div class="form-group">
                            <label for="how_many_any">যে কোন</label>
                    ...
                    <div class="col-md-4  how_many_male_female_children_other_part alive_children_no_availability_non_related_part alive_children_no_availability_parts alive_children_yes_availability_parts">
                        <div class="form-group">
