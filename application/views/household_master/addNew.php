                               ...
                               <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="livingYear" placeholder="Living Year"  name="livingYear" minlength="1" maxlength="2" size="10" required="required">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="Item Name">How long living here (Month)</label>
                                        <input type="text" class="form-control required" id="livingMonth" placeholder="Living Month"  name="livingMonth" minlength="1" maxlength="2" size="10" required="required">
                                    </div>
                                </div>
								...
								<div class="col-md-3 migin">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="leftSlum" placeholder="Month"  name="leftSlum" minlength="1" maxlength="2" size="10" required="required">
                                    </div>
                                </div>
