        ...
        <div class="row">
            ...
            <div class="col-xs-5 text-right">
                <div class="form-group margin5pxBot">
                    <a class="btn btn-primary" href="<?php echo base_url() . $controller . '/sav_format/household_master_view' . '?baseID=' . $baseID ?>">sav</a>
                    <a class="btn btn-primary" href="<?php echo base_url() . $controller . '/dta_format/household_master_view' . '?baseID=' . $baseID ?>">dta</a>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <table style="white-space: nowrap;" class="table" id="memberData">
                                <thead>
                                    <tr>
                                        ...
                                        <th>LEFTPAD</th>
                                        <th>entry_date</th>
                                        <th>round_master_id_entry_round</th>
                                        <th>migration_reason_oth</th>
                                        <th>extinct_date</th>
                                        <th>round_master_id_extinct_round</th>
                                        <th>location_id</th>
                                        <th>location_split_id</th>
                                        <th>district_code</th>
                                        <th>thana_code</th>
                                        <th>slum_code</th>
                                        <th>slum_area_code</th>
                                        <th>fk_entry_type_code</th>
                                        <th>fk_migration_reason_code</th>
                                        <th>country_from_code</th>
                                        <th>district_from_code</th>
                                        <th>thana_from_code</th>
                                        <th>slum_from_code</th>
                                        <th>slum_area_from_code</th>
...
<script>
    $(document).ready(function (e) {
        ...
        $('#memberData').DataTable({
            ...
            "ajax": {
                url: '<?php echo base_url() ?>Reports/show_household_master?baseID=<?php echo $baseID ?>',
                                type: 'POST'
                            },
                            ...
                            buttons: [{
                                    extend: 'excel',
                                    title: 'member household master report',
                                    exportOptions: {
