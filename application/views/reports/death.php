        ...
        <div class="row">
            ...
            <div class="col-xs-5 text-right">
                <div class="form-group margin5pxBot">
                    <div class="form-group margin5pxBot">
                        <a class="btn btn-primary" href="<?php echo base_url() . $controller . '/sav_format/death_view' . '?baseID=' . $baseID ?>">sav</a>
                        <a class="btn btn-primary" href="<?php echo base_url() . $controller . '/dta_format/death_view' . '?baseID=' . $baseID ?>">dta</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Death report</h3>
...
<script>
    $(document).ready(function (e) {
        ...
        $('#memberData').DataTable({
            ...
            "ajax": {
                url: '<?php echo base_url() ?>Reports/show_death_view?baseID=<?php echo $baseID ?>',
                                type: 'POST'
                            },
