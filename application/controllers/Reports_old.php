...
//        print_r($data['conception_info']); exit();
    ...
    public function sav_format_immunization() {

        $baseID = $this->input->get('baseID', TRUE);

        $result = $this->modelName->data_via_table_view_immunization('immunization_view');
        ...
        fclose($fp); //exit();
        $file_name = "immunization_List_Report";
        $command = escapeshellcmd("sav.py $uniqid $file_name");
        $output = shell_exec($command);


        $file = 'immunization_List_Report.sav';
        if (file_exists($file)) {
    ...
    public function dta_format_immunization() {
        ...
        $file = 'immunization_List_Report.dta';
        if (file_exists($file)) {
            header('Content-Description: File Transfer');
            header('Content-Type: application/octet-stream');
            header('Content-Disposition: attachment; filename=' . basename($file));
    ...
    public function sav_format_internal_in() {
        ...
        $result = $this->modelName->data_via_table_view_internal_in('internal_in_view');
...
//        print_r($result); exit();
    ...
    public function sav_format_internal_out() {
        ...
        $result = $this->modelName->data_via_table_view_internal_out('internal_out_view');
        if ($result == false) {
            $this->session->set_flashdata('error', 'No data is there, nothing to export.');
            redirect($this->controller . '/internal_out' . '?baseID=' . $baseID);
        }
...
//        print_r($result); exit();
    ...
    public function sav_format_marriage_start() {
        ...
        $result = $this->modelName->data_via_table_view_marriage_start('marriage_start_view');
        if ($result == false) {
            $this->session->set_flashdata('error', 'No data is there, nothing to export.');
            redirect($this->controller . '/marriage_start' . '?baseID=' . $baseID);
        }
...
//        exit();
    ...
    public function sav_format_marriage_end() {
        ...
        $result = $this->modelName->data_via_table_view_marriage_end('marriage_end_view');
...
//        $result = $this->modelName->data_via_table_view('member_view', 0);
//        $fp = fopen('demo2.json', 'w');
//        fwrite($fp, json_encode($result));
//        fclose($fp);
//
//        $inp = file_get_contents('demo2.json');
//        $tempArray = json_decode($inp);
//        
//        $row_number = 10;
//        $result2 = $this->modelName->data_via_table_view('member_view', $row_number);
//        while ($result2) {
//            foreach ($result2 as $each_row) {
//                array_push($tempArray, $each_row);
//            }
//            $row_number += 10;
//            $result2 = $this->modelName->data_via_table_view('member_view', $row_number);
//            break;
...
//        file_put_contents('demo2.json', $jsonData);
//
//        exit();

        $baseID = $this->input->get('baseID', TRUE);

//        $result = $this->modelName->all_member_info('', '', '', '', '', $this->config->item('memberMasterTable'), 0);
        $result = $this->modelName->data_via_table_view_member_master('member_view');
...
//        print_r($result); exit();
    ...
    public function sav_format_conception() {
        ...
        $result = $this->modelName->data_via_table_view_conception('conception_view');
    ...
    public function sav_format_pregnancy() {
        ...
        $result = $this->modelName->data_via_table_view_pregnancy('pregnancy_view');
...
//        print_r($result); exit();
    ...
    public function sav_format_birth() {
        ...
        $result = $this->modelName->data_via_table_view_birth('birth_view');
...
//        exit();
    ...
    public function sav_format_interview() {
        ...
        $result = $this->modelName->data_via_table_view_interview('interview_view');
...
//        exit();
    ...
    public function sav_format_household() {
        ...
        $result = $this->modelName->data_via_table_view_household_master('household_master_view');
        if ($result == false) {
            $this->session->set_flashdata('error', 'No data is there, nothing to export.');
...
//        exit();
    ...
    public function sav_format_migration_in() {
        ...
        $result = $this->modelName->all_migration_in_info(0, $this->config->item('migrationInTable'), 0);
...
//        exit();
    ...
    public function sav_format_asset() {
        ...
        $result = $this->modelName->all_asset_info(0, $this->config->item('householdAssetTable'), 0);
...
//        exit();
    ...
    public function sav_format_education() {
        ...
        $result = $this->modelName->all_education_info(0, $this->config->item('memberEducationTable'), 0);
...
//        exit();
    ...
    public function sav_format_occupation() {
        ...
        $result = $this->modelName->all_occupation_info(0, $this->config->item('memberOccupationTable'), 0);
...
//        exit();
    ...
    public function sav_format_relation() {
        ...
        $result = $this->modelName->all_relation_info(0, $this->config->item('memberRelationTable'), 0);
...
//        exit();
    ...
    public function sav_format_migration_out() {
        ...
        $result = $this->modelName->all_migration_out_info(0, $this->config->item('migrationOutTable'), 0);
...
//        exit();
    ...
    public function sav_format_household_head() {
        ...
        $result = $this->modelName->all_household_head_info(0, $this->config->item('memberHeadTable'), 0);
...
//        exit();
    ...
    public function sav_format_death() {
        ...
        $result = $this->modelName->all_death_info(0, $this->config->item('deathTable'), 0);
